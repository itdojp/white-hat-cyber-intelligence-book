...
第25章の過去の監査日2026-08-03は履歴として保持する。ICD203のcheckerは今回の限定監査日2026-09-26を最低日とし、既存の共有日付helperで後日の限定監査を許容する。旧監査日や前日への巻戻し、不正な日付や型は拒否し、CIA SATとIANA snapshotの完全一致条件は変更しない。日付だけを進めても版・適用範囲の確認や独立レビューの代わりにはならない。
