...
- 固定revisionからSeries UX共通コンポーネントを同期
- `docs/`生成、Jekyll build、Book QA、Pages workflowを検証
- 代表4章の独立レビュー
