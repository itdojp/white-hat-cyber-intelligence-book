...
| `chapter-16` | #40 | `selected-for-intake` | `EIC-0040-38fbe94b39aa` | — | [status](https://github.com/itdojp/white-hat-cyber-intelligence-book/issues/40#issuecomment-5758739823) |
...
| Candidate | Package | Input | Input SHA-256 | Disposition | Reason |
|---|---|---|---|---|---|
| `EIC-0040-38fbe94b39aa` | `EIP-0006` | `chapter16-telemetry-evidence-readiness.predraft.md` | `38fbe94b39aac0ad6e59fcaa0c2cd9bfffc23b4eb01ca4dbbfd1cfb470a00c32` | `selected` | PR146 actual-main公開と第II部完了後、唯一の登録候補EIC-0040-38fbe94b39aaをbranch前に設計来歴として選択。登録原料の実体は見つからず、読了/hash実照合/直接採用は主張しない。Issue40と現行契約・一次資料から新規制作し、同梱Chapter9の履歴を保持する。 |
