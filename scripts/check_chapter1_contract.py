...
def main() -> int:
    ...
    require_tokens(
        ...
        (
            ...
            "| Confidence | 中 |",
            "| `TEL-2026-001` | `EVD-2026-003` | Admin consent変更 | actor、app ID、scope、target tenant、timestamp | 180日 | Partial（検索対象90日のうち72日） |",
            "| `TEL-2026-004` | `EVD-2026-004` | App sign-in / Token利用 | app ID、credential ID、source、result、timestamp | 90日 | Partial（72日） |",
            "| `NEG-2026-001` | `EVD-2026-004` | 未承認同意変更、異常なApp sign-in、Data API利用 | 過去90日 | 同意変更とsign-inは72日分。API利用は一部のみ |",
            ...
            "| `MET-2026-002` | Critical hypothesis evidence coverage | 3 / 3 | 3 / 3を維持し、Gapの責任者と期限を明示 |",
            ...
            "| `MET-2026-001` | Decision latency | 47時間30分 | 48時間以内 |",
        ),
    )
