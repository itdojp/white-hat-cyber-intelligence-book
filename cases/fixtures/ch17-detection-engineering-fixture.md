...
合成rule本体は[`detections/cloud_identity/det_2026_017_001.json`](https://github.com/itdojp/white-hat-cyber-intelligence-book/blob/5a31db5a15a7583218b0bd49ca1a285d9348f0b0/detections/cloud_identity/det_2026_017_001.json)である。このリンクは監査済みcommit `5a31db5a15a7583218b0bd49ca1a285d9348f0b0`に固定している。Replay時は同一checkout内のrule、runner、fixtureを使用し、異なる版を混在させない。これは教材用の決定的な評価契約であり、実SIEM / EDRへ投入しない。
